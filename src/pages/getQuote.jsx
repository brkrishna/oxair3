      ...
      <Container className="mt-5">
        <Row>
          <Col>
            ...
            <div className="">
              <h2 className="roi-title my-4">ROI Oxair Oxygen Plant</h2>
              <p className="roi-subtitle mt-5">
                Cost of Cylinders @ INR 250 for 24 Cylinders Per Day
              </p>
              <div className="row justify-content-between mt-5">
                <div className="col-md-4 col-sm-6 col-12 mb-3">
                  <div className="card-width">
                    <div className="content">
                      <p className="cylindersperday">
                        No of cylinders<br />
                        <span className="smallfont">Per day</span>
                      </p>
                    </div>
                    <div className="bg-bluecolor">
                      <h1 className="cylinderfont">24x250x365</h1>
                    </div>
                  </div>
                </div>
                <div className="col-md-4 col-sm-6 col-12 mb-3">
                  <div className="card-width">
                    <div className="content">
                      <p className="cylindersperday">
                        Cost of cylinders<br />
                        <span className="smallfont">for one year</span>
                      </p>
                    </div>
                    <div className="bg-bluecolor">
                      <h1 className="cylinderfont">21,90,000/-</h1>
                    </div>
                  </div>
                </div>
                <div className="col-md-4 col-sm-6 col-12 mb-3">
                  <div className="card-width">
                    <div className="content">
                      <p className="cylindersperday">
                        ...
                        <span className="smallfont">@250 per cylinder for a consumption of 24 cylinders per day</span>
                      </p>
                    </div>
                    <div className="bg-bluecolor">
                      <h1 className="cylinderfont">21,90,000/-</h1>
